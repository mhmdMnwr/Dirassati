  ...
  void getHomeWorkData({required String studentId}) async {
    ...
    final dummyHomeWorks = [
      HomeWorkModel(
        ...
        description: "حل التمارين من صفحة 45 إلى 50 في كتاب الرياضيات، التركيز على عمليات الضرب والقسمة",
      ...
      HomeWorkModel(
        ...
        description: "قراءة النص في الصفحة 25 وكتابة ملخص لا يقل عن 100 كلمة، مع استخراج الكلمات الصعبة",
      ...
      HomeWorkModel(
        ...
        description: "إجراء تجربة لفصل الماء عن الزيت وكتابة تقرير مفصل عن النتائج المشاهدة",
      ...
      HomeWorkModel(
        ...
        description: "كتابة بحث من 3 صفحات عن إنجازات الحضارة الإسلامية في العلوم والطب",
        attachments: [],
      ...
      HomeWorkModel(
        ...
        description: "Complete exercises 1-20 on page 35, focusing on present simple and present continuous tenses",
