...
mixin _$GetMyStudentsState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T students) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(T students)? success,
...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(this.students);
  ...
  @override
  String toString() {
    return 'GetMyStudentsState<$T>.success(students: $students)';
  }
...
abstract class Success<T> implements GetMyStudentsState<T> {
  const factory Success(final T students) = _$SuccessImpl<T>;
