...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(this.data, {required this.hasMore});
  ...
  @override
  String toString() {
    return 'NotificationsState<$T>.success(data: $data, hasMore: $hasMore)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(data), hasMore);
...
abstract class Success<T> implements NotificationsState<T> {
  const factory Success(final T data, {required final bool hasMore}) =
      _$SuccessImpl<T>;
