...
class TextStyles {
  ...
  static TextStyle font24SecBlueExtraBold = TextStyle(
    fontSize: 24.sp,
    fontWeight: FontWeightHelper.extraBold,
    color: ColorsManager.seconderyBlue,
  );
  static TextStyle font24SkyBlueExtraBold = TextStyle(
    fontSize: 24.sp,
    fontWeight: FontWeightHelper.extraBold,
  ...
  static TextStyle font12SkyBlueRegular = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.skyBlue,
  );
